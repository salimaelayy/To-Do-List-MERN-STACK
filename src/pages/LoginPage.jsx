...
const LoginPage = () => {
  return (
    <div className='justify-center flex  mt-40  '>
      <div
  className="relative flex w-1/2 h-[700px] flex-col rounded-3xl bg-white border border-cyan-500 bg-clip-border text-gray-700 shadow-md"
>
  <div
  ...
  >
    <h3
      className="block font-sans text-4xl font-semibold leading-snug tracking-normal text-white antialiased"
    >
      Sign In
    </h3>
  </div>
  ...
  <div className="p-6 pt-0">
    <button
      ...
      type="button"
      className="block w-full select-none rounded-lg bg-gradient-to-tr from-cyan-600 to-cyan-400 py-4 px-8 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-cyan-500/20 transition-all hover:shadow-lg hover:shadow-cyan-500/40 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
    >
      Sign In
    </button>
    <p
