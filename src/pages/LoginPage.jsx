...
const LoginPage = () => {
  return (
    <>
    <div className='  flex justify-center items-center  bg-gradient-to-tr from-cyan-600 to-cyan-400  h-screen'>
    <div  className="relative flex w-1/3 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
  ...
  <div className="p-6 pt-0">
    <button
      ...
      type="button"
      class="block w-full  h-14 select-none rounded-lg bg-gradient-to-tr from-cyan-600 to-cyan-400 py-3 px-6 text-center align-middle font-sans text-xl font-bold uppercase text-white shadow-md shadow-cyan-500/20 transition-all hover:shadow-lg hover:shadow-cyan-500/40 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
    >
      Sign In
    </button>
    <p
