...
const RegisterPage = () => {
  return (
    ...
    <div className="form w-[300px] rounded-md shadow-xl overflow-hidden z-[100] relative cursor-pointer snap-start shrink-0 py-5 px-6 bg-[#DFA16A] r flex flex-col items-center justify-center gap-3 transition-all duration-300" >
    ...
    <div className="capitalize">
      ...
      <form action="" className="flex flex-col gap-3">
        <div className="flex flex-col items-start w-full">
          <label for="name" className="text-sm text-[#7F3D27] font-semibold">Name </label>
          <input
            type="text"
